<template>
  <div>
    ...
    <div>
      <el-table :data="state.table" border style="width: 100%">
        ...
        <el-table-column align="center" prop="content" label="内容" width="180" />
        <el-table-column align="center" prop="status" label="状态" />
        <el-table-column align="center" prop="updateTime" label="更新时间" width="180" />
        <el-table-column align="center" prop="logistics.logisticsCompany" label="权快递公司" width="180" />
  ...
  <Edit :dialogFormVisible="state.dialogFormVisible" :val="state.dialogVal" @close="handle_close"
    @success="handle_success"></Edit>
</template>
...
import { getList,del } from '../../api/complaint';
...
async function search() {
  const data = await getList(pagination.value)
